...
ADD target/patch-management-services-0.0.1-SNAPSHOT.jar /run/patch-management-services-0.0.1-SNAPSHOT.jar
...
ENTRYPOINT exec java -jar /run/patch-management-services-0.0.1-SNAPSHOT.jar
